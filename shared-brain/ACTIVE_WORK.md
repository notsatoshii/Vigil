# ACTIVE WORK
## Updated by scheduler at 04:44:54 UTC

Sessions today: 29/80
...
- **lever-bug-3**: LEVER-BUG-3: [CRITICAL] Ghost OI ($3.2M with zero positions) [verifying (12m)]
- **lever-bug-4**: LEVER-BUG-4: [CRITICAL] InsuranceFund never absorbs bad debt [verifying (7m)]
- **lever-bug-5**: LEVER-BUG-5: [CRITICAL] InsuranceFund decimal mismatch (WAD  [verifying (26m)]
- **lever-bug-6**: LEVER-BUG-6: [CRITICAL] FeeRouter called without USDT by Liq [planned]
- **lever-bug-7**: LEVER-BUG-7: [CRITICAL] Zero liquidations (depthThreshold un [building (4m)]
- **lever-bug-8**: LEVER-BUG-8: [HIGH] No closing transaction fee (10bps forego [critiquing (1m)]
- **lever-bug-9**: LEVER-BUG-9: [HIGH] Vault NAV missing unrealized PnL [planned]
...
- **support-improve**: support-improve [backlog (1m)]
